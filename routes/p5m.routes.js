...
const publicBaseUrl = process.env.PUBLIC_BASE_URL;
      ...
      infoCell.value =
        `Generated By: ${req.user.name || req.user.id} | Role: ${req.user.role} | Site: ${req.user.site_id} | Generated At: ${now.toLocaleString()}`;
      infoCell.font = {
        italic: true,
        size: 11,
        color: { argb: "FF374151" },
  ...
  excelRow.eachCell((cell, colNumber) => {
    cell.alignment = {
      vertical: "top",
      horizontal:
        colNumber === 1 || colNumber === 9 || colNumber === 10
          ? "center"
          : "left",
      wrapText: true,
    };
  ...
  if (
    statusHariKerjaValue.includes("aman") ||
    ...
    statusHariKerjaValue.includes("tidak") ||
  ...
  // hyperlink untuk Foto (kolom O = 15)
  if (fotoUrl) {
