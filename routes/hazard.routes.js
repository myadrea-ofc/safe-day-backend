  ...
  async (req, res) => {
    try {
      ...
      worksheet.columns = [
        ...
        { key: "foto1_path", width: 28 },
        { key: "foto2_path", width: 28 },
        { key: "foto3_path", width: 28 },
      ];
      ...
      for (let i = 0; i < result.rows.length; i++) {
        ...
        const foto1Url = row.foto1_path
          ? `http://safety.borneo.co.id/uploads/${encodeURIComponent(row.foto1_path)}`
          : "-";

        const foto2Url = row.foto2_path
          ? `http://safety.borneo.co.id/uploads/${encodeURIComponent(row.foto2_path)}`
          : "-";

        const foto3Url = row.foto3_path
          ? `http://safety.borneo.co.id/uploads/${encodeURIComponent(row.foto3_path)}`
          : "-";
        ...
        // hyperlink foto 1
        const foto1Cell = excelRow.getCell(16);
        if (foto1Url !== "-") {
          foto1Cell.value = {
            text: "Lihat Foto 1",
            hyperlink: foto1Url,
        ...
        // hyperlink foto 2
        const foto2Cell = excelRow.getCell(17);
        if (foto2Url !== "-") {
          foto2Cell.value = {
            text: "Lihat Foto 2",
            hyperlink: foto2Url,
        ...
        // hyperlink foto 3
        const foto3Cell = excelRow.getCell(18);
        if (foto3Url !== "-") {
          foto3Cell.value = {
            text: "Lihat Foto 3",
            hyperlink: foto3Url,
