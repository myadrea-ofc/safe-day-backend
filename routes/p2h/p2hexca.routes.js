  ...
  (req, res) => {
    upload.array("files", 5)(req, res, async (err) => {
      ...
      try {
        ...
        const query = `
        INSERT INTO p2h_exca (
          nama, jabatan, department, perusahaan,
          no_lambung_unit, hm_sekarang, waktu_p2h, shift_kerja,
          ...
          opsi_item26, opsi_item27, opsi_item28, 
      ...
      `;
        ...
        console.error("P2H EXCAVATOR POST ERROR:", e);
        return res.status(500).json({
          success: false,
          error: e.message,
        });
...
router.get("/", authMiddleware, async (req, res) => {
  try {
    ...
    console.error("P2H EXCA GET ERROR:", err);
...
router.get(
  "/export.xlsx",
  authMiddleware,
  ensureExcelDownloadAccess("p2h_exca"),
  async (req, res) => {
    try {
      const { role, site_id } = req.user;
      ...
      const exportFileName = `P2H_EXCA_${formattedDate}.xlsx`;
      ...
      const worksheet = workbook.addWorksheet("P2H Exca Export");
      ...
      worksheet.columns = [
        ...
        { key: "no_lambung_unit", width: 20 },
        { key: "hm_sekarang", width: 16 },
        { key: "waktu_p2h", width: 16 },
        { key: "shift_kerja", width: 14 },
        { key: "tanggal", width: 16 },
        { key: "lok_kerja", width: 22 },

        { key: "opsi_item1", width: 22 },
        { key: "opsi_item2", width: 30 },
        { key: "opsi_item3", width: 22 },
        { key: "opsi_item4", width: 18 },
        { key: "opsi_item5", width: 18 },
        { key: "opsi_item6", width: 30 },
        { key: "opsi_item7", width: 20 },
        { key: "opsi_item8", width: 22 },
        { key: "opsi_item9", width: 18 },
        { key: "opsi_item10", width: 32 },
        { key: "opsi_item11", width: 28 },
        { key: "opsi_item12", width: 18 },
        { key: "opsi_item13", width: 18 },
        { key: "opsi_item14", width: 20 },
        { key: "opsi_item15", width: 20 },
        { key: "opsi_item16", width: 18 },
        { key: "opsi_item17", width: 18 },
        { key: "opsi_item18", width: 24 },
        { key: "opsi_item19", width: 24 },
        { key: "opsi_item20", width: 18 },
        { key: "opsi_item21", width: 20 },
        { key: "opsi_item22", width: 20 },
        { key: "opsi_item23", width: 18 },
        { key: "opsi_item24", width: 30 },
        { key: "opsi_item25", width: 18 },
        { key: "opsi_item26", width: 20 },
        { key: "opsi_item27", width: 28 },
        { key: "opsi_item28", width: 18 },

        { key: "opsi_standar_keselamatan1", width: 24 },
        { key: "opsi_standar_keselamatan2", width: 28 },
        { key: "opsi_standar_keselamatan3", width: 16 },
        { key: "opsi_standar_keselamatan4", width: 18 },
        ...
        { key: "status_keadaan3", width: 36 },
        { key: "status_keadaan4", width: 28 },
        { key: "status_keadaan5", width: 24 },
        { key: "status_keadaan6", width: 24 },
      ...
      titleCell.value = "LAPORAN EXPORT P2H EXCAVATOR";
      titleCell.font = {
        bold: true,
        size: 16,
        color: { argb: "FFFFFFFF" },
      ...
      for (let i = 0; i < result.rows.length; i++) {
        ...
        for (let j = 0; j < 5; j++) {
          ...
          const fileCell = excelRow.getCell(56 + j);
      ...
      await pool.query(
        ...
        VALUES ($1, $2, $3)
        `,
        [req.user.id, req.user.site_id, "p2h_exca"],
      );
    } catch (err) {
      console.error("P2H EXCA EXPORT XLSX ERROR:", err);
