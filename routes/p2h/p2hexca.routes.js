...
// ===================== GET =====================
router.get("/", authMiddleware, auditMiddleware("P2H Excavator"), async (req, res) => {
  try {
  ...
  async (req, res) => {
    try {
      ...
      worksheet.columns = [
        ...
        { key: "hm_sekarang", width: 20 },
        { key: "waktu_p2h", width: 20 },
        { key: "shift_kerja", width: 20 },
        { key: "tanggal", width: 20 },
        { key: "lok_kerja", width: 25 },
        ...
        { key: "opsi_standar_keselamatan4", width: 30 },
