...
async function sendNewPasswordEmail({ to, name, siteName, departmentName, newPassword }) {
            ...
            <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,.08);">
              ...
              <tr>
                <td style="padding:22px 24px;">
                  <div style="font-size:16px;font-weight:800;margin-bottom:8px;">Password Baru Anda</div>
                  ...
                  <div style="margin-top:16px;">
                    ...
                    <div style="font-family:Consolas, 'Courier New', monospace;font-size:18px;font-weight:800;letter-spacing:.5px;padding:14px 16px;border-radius:14px;background:#111827;color:#ffffff;display:inline-block;">
